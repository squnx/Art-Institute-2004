...
function hiddenrefel($var_form) {
	if ($_POST[$var_form]!="") {
		...
		print "<input type=\"hidden\" name=\"".$var_form."\" value=\"".$input."\">".$sep.$input;
		}
    }

function referral($name,$email,$phone) {
	$name =ltrim($name);
	$email =ltrim($email);
	$phone =ltrim($phone);
	if (($name!="") && ($email!="" || $phone!="")) {
...
<script language="JavaScript">
  ...
  {
    newWindow = window.open(url,"popup","width=400,height=300,RESIZABLE=NO,SCROLLBARS=NO,STATUS=YES,MENUBAR=NO,TOOLBAR=NO")
  } // open_new_win()
</script>
<script language="JavaScript">
	function open_new_win(url)
...
$ref=referral($_POST['f_name'],$_POST['f_email'],$_POST['f_phone']);
?>
	...
	<table width="780" cellspacing="0" cellpadding="0" border="0">
	  ...
	  <tr>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
		<td width="110" class="main12" valign="top"><b>E-mail Address</b></td>
		<td width="20" class="main13" valign="top">&nbsp;</td>
	  ...
	  <tr>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
		<td width="110" class="main12" valign="top"><b>code number</td>
		<td width="20" valign="top"><img src="../images/dot.gif" width="20" height="1"></td>
		<td width="510" class="main12" valign="top"><?php hiddenel(code); ?></td>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
	  </tr>
<?php 
	if ($ref=="Yes") {
?>
	  <tr>
		...
		<td width="20" class="main13" valign="top">&nbsp;</td>
		<td width="510" class="main12" valign="top"><?php hiddenrefel(f_name); ?><?php hiddenrefel(f_email); ?><?php hiddenrefel(f_phone); ?></td>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
	  </tr>
<?php
		}
...
?>
	  ...
	  <tr>
		<td width="780" colspan="2" background="images/nav02.gif" valign="top"><img src="../images/dot.gif" width="780" height="24" name="myimg1" border="0" usemap="#nav"></td>
		<map name="nav">
		<area shape=rect coords="710,0 780,24" href="../index.html" onMouseOut="RestoreImg()" onMouseOver="SwitchImg('document.myimg1','document.myimg1','../images/nav00.gif')">
		</map>
	  </tr>
...
$sql_insert="insert into $table (name,address,city,state,zipcode,email,phone,grad_date,interest,f_name,f_email,f_phone,tstamp, mail, call, servername)
			values ('$name','$address','$city','$state','$zipcode','$email','$phone','$grad_date','$interest','$f_name','$f_email','$f_phone','$tstamp','$mail','$call','$servername')";
...
?>
	...
	<table width="780" cellspacing="0" cellpadding="0" border="0">
	  ...
	  <tr>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
		<td width="110" class="main12" valign="top"><b>Enter code number</b></td>
		<td width="20" class="main13" valign="top">*</td>
		<td width="220" valign="top"><?php formel(city,30,40); ?></td>
		<td width="290" valign="top"><img src="../images/dot.gif" width="290" height="1"></td>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
	  ...
	  <tr>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
		<td width="110" class="main12" valign="top"><b>E-mail</b></td>
		<td width="20" valign="top"><img src="../images/dot.gif" width="20" height="1"></td>
	  ...
	  <tr>
		...
		<td width="110" valign="top"><img src="../images/dot.gif" width="110" height="1"></td>
		<td width="20" valign="top"><img src="../images/dot.gif" width="20" height="1"></td>
		<td width="220" class="main12" valign="top"><input type="image" name="submit" src="images/button01.gif" width="95" height="37" border="0" value=""></td>
		<td width="290" valign="top"><img src="../images/dot.gif" width="290" height="1"></td>
		<td width="70" valign="top"><img src="../images/dot.gif" width="70" height="1"></td>
	  </tr>
	  <tr>
